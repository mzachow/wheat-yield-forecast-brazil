...
def read_raw_model_data():
    ...
    """ 
    ukmo = pd.read_csv("data/raw hindcasts/ukmo.csv", dtype={"date":str, "group":int}, parse_dates=["date"])
    ncep = pd.read_csv("data/raw hindcasts/ncep.csv", dtype={"date":str, "group":int}, parse_dates=["date"])
    ecmwf = pd.read_csv("data/raw hindcasts/ecmwf.csv", dtype={"date":str, "group":int}, parse_dates=["date"])
...
def read_observed_weather():
    ...
    all_files = glob.glob("data/observed climate/*.csv")
    li = []
